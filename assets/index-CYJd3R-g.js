(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const e of n.addedNodes)e.tagName==="LINK"&&e.rel==="modulepreload"&&l(e)}).observe(document,{childList:!0,subtree:!0});function d(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(i){if(i.ep)return;i.ep=!0;const n=d(i);fetch(i.href,n)}})();const c=[{id:1,title:"Work Timer",description:"Work Timer, çalışma zamanınızı düzenleyip takip edebileceğiniz ve ne kadar çalıştığınızı istatiksel takip edebileceğiniz bir Windows platformu yazılımıdır. Aşağıdaki bağlantı ile kurulum dosyasını indirebilirsiniz.",version:"1.0.4.230",updatedAt:"14.03.2023",downloadUrl:"WorkTimeSetup.exe",icon:"icon.ico",videoUrl:"",screenshots:["screen1.png","screen2.png"],tags:["Utility","Productivity"]},{id:2,title:"PasswordGen",description:"Password Generator, güçlü şifreler oluşturabileceğiniz ve bunları detaylı bir şekilde kontrol edip daha da güçlendirebileceğiniz ve bir çok özellik daha barındıran bir Windows yazılımıdır.",version:"1.1.1",updatedAt:"23.08.2023",downloadUrl:"PasswordGen.exe",icon:"icon.ico",videoUrl:"",screenshots:["screen1.png","screen2.png","screen3.png","screen4.png","screen5.png","screen6.png"],tags:["Security","Tool"]},{id:3,title:"Robotica",description:"Ürün kullanıcılıya sunulmak üzere geliştirilmeye devam ediyor.<br><br>Robotica, endüstriyel robot kolun analizlerini ve 3B simülasyonunu görselleştiren bir Windows yazılımıdır.",version:"1.0.0",updatedAt:"05.01.2026",isSoon:!0,icon:"robotica-logo-t.png",videoUrl:"https://youtu.be/dXGuwFJMnCo",screenshots:["s1.gif","s2.gif","s3.png","s4.png","s5.gif","s6.png","s7.gif","s8.png","s9.png"],tags:["Robotics","Analysis","Simulation"]},{id:4,title:"Staj Günlüğü",description:"Staj Günlüğü, staj sırasında yapacağınız notları ve görüntüleri tutabileceğiniz ve bunları detaylı bir şekilde kontrol edip daha da güçlendirebileceğiniz ve bir çok özellik daha barındıran bir Android uygulamasıdır. Aşağıdaki bağlantı ile direkt indirebilirsiniz.",version:"2.1.0",updatedAt:"12.02.2026",downloadUrl:"Staj Günlüğü.apk",icon:"icon.png",videoUrl:"",screenshots:["s1.jpeg","s2.jpeg","s3.jpeg","s4.jpeg","s5.jpeg"],tags:["Android"],changelog:[{version:"2.1.0",date:"12.02.2026",changes:["İzin günü özelliği eklendi.","Kapsamlı görsel iyileştirmeler yapıldı.","Uygulama performansında optimizasyonlar sağlandı."]},{version:"2.0.0",date:"20.01.2026",changes:["Kapsamlı görsel iyileştirmeler yapıldı.","Uygulama performansında optimizasyonlar sağlandı.","Yedekleme ve bir çok yeni özellik eklendi."]},{version:"1.1.0",date:"01.12.2025",changes:["İlk sürüm yayınlandı.","Temel not alma özellikleri eklendi.","Görsel ekleme desteği getirildi."]}]},{id:5,title:"Frosse Stok Takip",description:"Frosse Stok Takip, stok takibi yapabileceğiniz ve bu stokları detaylı bir şekilde kontrol edip daha da güçlendirebileceğiniz ve bir çok özellik daha barındıran bir Android uygulamasıdır. Frosse Freeze Dry markası için geliştirilmiş ve kullanıma sunulmuştur.",version:"1.0.1",updatedAt:"24.02.2026",icon:"icon.png",screenshots:["v1.gif","v2.gif","s1.jpeg","s2.jpeg","s3.jpeg","s4.jpeg"],tags:["Android","Stock Management"]},{id:6,title:"WeMo Share",description:"Web, mobil ve diğer cihazlarınız arasında hızlı ve güvenli bir şekilde dosya/metin paylaşabileceğiniz ücretsiz bir servis.",version:"1.0.3",updatedAt:"13.03.2026",icon:"icon.png",screenshots:["s1.png","s2.png","s3.png"],targetUrl:"https://wemo-share.web.app/",tags:["Web","Mobile","File Sharing"]}],p=document.querySelector("#app");function h(){p.innerHTML=`
  ...
  `;const s=document.getElementById("screenshot-modal"),r=s.querySelector(".close-modal"),d=document.getElementById("modal-images"),l=document.getElementById("changelog-modal"),i=l.querySelector(".close-modal"),n=document.getElementById("changelog-content");window.openScreenshots=e=>{const a=c.find(t=>t.id===e);if(!a||!a.screenshots)return;const o=`/apps/${a.id}`;d.innerHTML=a.screenshots.map(t=>{const g=t.toLowerCase().endsWith(".gif");return`
      ...
      `}).join(""),s.style.display="flex",document.body.style.overflow="hidden"},window.openChangelog=e=>{const a=c.find(o=>o.id===e);!a||!a.changelog||(n.innerHTML=`
    ...
    `,l.style.display="flex",document.body.style.overflow="hidden")},r.onclick=()=>{s.style.display="none",document.body.style.overflow="auto"},i.onclick=()=>{l.style.display="none",document.body.style.overflow="auto"},window.onclick=e=>{e.target===s?(s.style.display="none",document.body.style.overflow="auto"):e.target===l&&(l.style.display="none",document.body.style.overflow="auto")}}h();window.addEventListener("scroll",()=>{const s=document.querySelector(".header");window.scrollY>50?s.classList.add("scrolled"):s.classList.remove("scrolled")});
